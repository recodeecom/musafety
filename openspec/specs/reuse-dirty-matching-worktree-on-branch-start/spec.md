# reuse-dirty-matching-worktree-on-branch-start Specification

## Purpose
TBD - created by archiving change agent-codex-reuse-dirty-matching-worktree-on-branch-2026-04-28-00-56. Update Purpose after archive.
## Requirements
