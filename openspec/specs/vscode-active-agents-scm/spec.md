# vscode-active-agents-scm Specification

## Purpose
TBD - created by archiving change agent-codex-vscode-active-agents-scm-badge-visibilit-2026-04-21-18-31. Update Purpose after archive.
## Requirements
