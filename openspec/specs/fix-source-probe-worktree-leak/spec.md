# fix-source-probe-worktree-leak Specification

## Purpose
TBD - created by archiving change agent-claude-fix-source-probe-worktree-leak-2026-04-20-00-27. Update Purpose after archive.
## Requirements
