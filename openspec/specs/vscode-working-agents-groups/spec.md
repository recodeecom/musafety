# vscode-working-agents-groups Specification

## Purpose
TBD - created by archiving change agent-codex-vscode-working-agents-groups-2026-04-22-09-05. Update Purpose after archive.
## Requirements
