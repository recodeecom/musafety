# vscode-active-agents-scm-commit-input Specification

## Purpose
TBD - created by archiving change agent-codex-vscode-active-agents-scm-commit-input-2026-04-22-10-55. Update Purpose after archive.
## Requirements
