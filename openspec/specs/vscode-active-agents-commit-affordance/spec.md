# vscode-active-agents-commit-affordance Specification

## Purpose
TBD - created by archiving change agent-codex-hide-active-agents-source-control-commit-2026-04-24-16-47. Update Purpose after archive.
## Requirements
