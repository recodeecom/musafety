# vscode-active-agents-sidebar-icon Specification

## Purpose
TBD - created by archiving change agent-codex-move-active-agents-to-own-sidebar-icon-2026-04-23-14-13. Update Purpose after archive.
## Requirements
