# vscode-active-agents-session-health Specification

## Purpose
TBD - created by archiving change agent-codex-show-session-health-in-active-agents-2026-04-23. Update Purpose after archive.
## Requirements
