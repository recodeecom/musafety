# fix-remaining-cli-ci-failures Specification

## Purpose
TBD - created by archiving change agent-codex-fix-remaining-cli-ci-failures-2026-04-21-11-42. Update Purpose after archive.
## Requirements
