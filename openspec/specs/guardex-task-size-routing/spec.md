# guardex-task-size-routing Specification

## Purpose
TBD - created by archiving change agent-codex-auto-route-small-tasks-to-caveman-and-la-2026-04-22-01-20. Update Purpose after archive.
## Requirements
