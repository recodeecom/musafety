# vscode-active-agents-scm-provider-layout Specification

## Purpose
TBD - created by archiving change agent-codex-vscode-active-agents-scm-provider-layout-2026-04-21-23-22. Update Purpose after archive.
## Requirements
